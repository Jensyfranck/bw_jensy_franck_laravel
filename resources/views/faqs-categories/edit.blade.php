...
@section('content')
    <div class="container mx-auto px-4">
        <h1 class="text-2xl font-bold text-gray-800 my-4">Edit FAQ Category</h1>
        ...
        {{-- FAQ Category Edit Form --}}
        <form method="POST" action="{{ route('faqs-categories.update', $category->id) }}" class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            @csrf
            @method('PUT')
